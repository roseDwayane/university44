...
Yanfly.Param.EquipFinishCmd = '完成';//String(Yanfly.Parameters['Finish Command']);
Yanfly.Param.EquipRemoveText = '卸下';//String(Yanfly.Parameters['Remove Text']);
Yanfly.Icon.RemoveEquip = Number(Yanfly.Parameters['Remove Icon']);
Yanfly.Param.EquipEmptyText = '無';//String(Yanfly.Parameters['Empty Text']);
...
Game_Actor.prototype.equipSlots = function() {
    ...
    if (slots.length >= 2 && this.isDualWield()) slots[1] = 1, slots[4] = 1 ;
    return slots;
};
